  ...
  return (
    <div>
      <Title
        ...
        font="outfit"
        title="Dashboard"
        subTitle="Monitor your room litings, track bookings and analyze revenue- all in one place. Stay updated with real-time insights to ensure smooth operations."
      />
            ...
            {dashboardData.bookings.map((item, index) => (
                <tr key={index}>
                    ...
                    <td className="py-3 px-4 border-t border-gray-300 flex">
                        <button className={`py-1 px-3 rounded-full text-xs mx-auto ${item.isPaid? "bg-green-200 text-green-600": "bg-amber-200 text-yellow-600"}`}>
