...
const ListRoom = () => {
  ...
  return (
    <div>
        <Title align='left' font='outfit' title='Room Listings' subTitle='View, edit, or manage all listed rooms. Keep the infornmation up-to-date to provide the best experience for users.'/>
                    ...
                    <tr key={index}>
                        ...
                        <td className='py-3 px-4 text-center border-t border-gray-300 text-sm text-red-500'>
                            <label className='relative inline-flex items-center cursor-pointer text-gray-900 gap-3'>
                                ...
                                <span className='dot absolute left-1 top-1 w-5 h-5 bg-white rounded-full transition-transform duration-200 ease-in-out peer-checked:traslate-x-5'></span>
                            </label>
                        </td>
                    </tr>
                ))
