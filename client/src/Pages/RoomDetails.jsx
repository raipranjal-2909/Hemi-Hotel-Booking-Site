    ...
    room && (
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
        ...
        <form
          ...
          className="flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto max-w-6xl mt-16"
        >
        ...
        <div className="max-w-3xl border-y border-gray-300 my-15 py-15 text-gray-500">
          <p>
            ...
            availability. You get a Two bedroom apartment has a true city
            feeling. The price quoted is for two guest, at the guest slot please
            mark the number of guest to get the exact prices for groups. The
            Guests will be allocated ground floor according to availability. You
            get the comfortable two bedroom apartment that has true city
            feeling.
          </p>
        </div>
        ...
        <div className="flex flex-col items-start gap-4">
          ...
          <div className="px-6 py-2.5 mt-4 rounded text-white bg-primary hover:bg-primary-dull transition-all cursor-pointer">
            Contact Now
          </div>
        </div>
      </div>
